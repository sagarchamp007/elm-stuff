...
processCondStmt (Line ifLi) (If cond (Block bls)) (Line elLi) (Else (Block bls1)) grid r_index allFunc_ls =
         let
          ...
          condition = 
            case cond of
                 ...
                 IsError -> True
         in if(condition) then (processBlock bls r_index allFunc_ls grid) else (processBlock bls1 r_index allFunc_ls grid)
                              ...
                              (stmt::ls) ->
                               let
                                ...
                                ans = case stmt of
                                    ...
                                    ConditionalStmt li ifb li1 el ->
                                                                  let
                                                                   (gri,pr,ind,str) =  processCondStmt li ifb li1 el grid r_index allFunc_ls
                                                                  in (gri,pr++ls,ind,str)
                               in ans
